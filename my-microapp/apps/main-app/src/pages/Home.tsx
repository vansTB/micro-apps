...
function Home() {
  ...
  return (
    <div style={{ padding: "24px" }}>
      <h1>Main App - Communication Hub111</h1>
      ...
      >
        ...
        {messages.length === 0 ? (
          <p style={{ color: "#999" }}>
            No messages yet. Try sending one from here or from a child app.
          </p>
        ) : (
          <ul style={{ listStyle: "none", padding: 0 }}>
            {messages.map((msg) => (
              ...
              >
                ...
                <span
                  style={{ float: "right", color: "#999", fontSize: "12px" }}
                >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "12px", marginTop: "8px" }}>
          <Link to="/react-child" style={{ color: "#61dafb", fontWeight: 600 }}>
            React Child App
          </Link>
          <Link to="/vue-child" style={{ color: "#42b883", fontWeight: 600 }}>
            Vue Child App
          </Link>
        </div>
      </section>
